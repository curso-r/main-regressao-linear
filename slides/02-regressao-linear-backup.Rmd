...
output:
  xaringan::moon_reader:
    css: ["default", "default-fonts", "css/custom-intro.css", "xaringan-themer.css"]
    lib_dir: libs
    nature:
...
# Usos da Regressão Linear ("duas culturas")
...
```{r, fig.align="center", fig.height=5, fig.width=10, dpi = 300}
